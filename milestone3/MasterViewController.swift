...
class MasterViewController: UITableViewController {
    ...
    func insertNewObject(_ sender: Any) {
        /*let newItem = Item(itemName:"item Number \(count)",itemQuantity:count,itemDescription:"This is the description of \(count)")
        count += 1
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.itemQuantityLabel.text! = object.itemQuantity
        
        cell.itemName = object.itemName
        cell.itemQuantity = object.itemQuantity
        cell.itemDescription = object.itemDescription
